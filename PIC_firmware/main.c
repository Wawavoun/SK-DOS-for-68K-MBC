...
S310121-R231021 - IOS - I/O Subsystem for the 68008 CPU (8MHz)
 
Modified 02/2025 by Philippe Roehr for SK*DOS support
...
S310121-R231021   Added support for the SPP Adapter (A240721-R270921);
...
Compiled with MPLABX v5.45 + XC8 v2.32 + MCC v5.0.3
...
#define             SKDOSFN             "SKDOS.BIN"         // SK*DOS 68K binary file
...
const uint32_t      SKDOSLDADR          =   0x01000;        // Loading address for the SKDOSFN file
const uint32_t      SKDOSSTADR          =   0x01000;        // Starting address for the SKDOSFN file execution
...
void main(void)
{
  ...
  printf("Modified 18/02/2025 by Ph.Roehr for SK*DOS support\r\n\n");
    ...
    case 3:                                               // Load an OS from current Disk Set on SD
      switch (diskSet)
      {
        ...
        case 1:                                           // SK*DOS
          fileNameSD = SKDOSFN;
          sect128Flag = 0;
          loadStarAddr = SKDOSLDADR;
          execStarAddr = SKDOSSTADR;
        break;
      }
    break;
  }
...
inline void execWriteOpcode()
{
  ...
  // Execute the requested I/O WRITE Opcode. The 0xFF value is reserved as "No operation".
  {
    ...
    case  0x12:
      ...
      {
        // NOTE: The I2C protocol introduces delays greater than needed by the SPP, so no further delay is used here to generate the pulse
        I2C2_Write1ByteRegister(GPIOEXP_ADDR, GPIOB_REG, ioData);       // Data on GPIOB
